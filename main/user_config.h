...
/* 按键 GPIO
 * 已被 LCD 占用: 5(DC),11(SCK),12(MOSI),40(CS),41(RST)
 * 已被 I2C 占用: 13(SDA),14(SCL)
 * V1.0.70: tone_player 改走 I2S(PCM 合成→ES8311/NS4168), GPIO6 释放为闲置
 * (旧: 6 曾为 tone_player 方波输出, 原 GPIO48 与震动 EN 冲突已移脚, 现 48 归震动)
 *
