...
/* V1.0.70: 探测结果查询. 供 audio_player 区分平台:
 *   有 ES8311 → 官方板 (GPIO46=PA 功放使能, 静音走软静音)
 *   无 ES8311 → 自制板 NS4168 I2S 数字功放 (GPIO46=CTRL 硬静音) */
bool es8311_is_present(void) { return s_present; }
