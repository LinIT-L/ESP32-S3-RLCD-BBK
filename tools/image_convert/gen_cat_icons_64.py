...
DST = os.path.join(os.path.dirname(__file__), "../../components/ui_common/cat_icons.inc")
W = H = 64
THRESHOLD = 128

MAP = [
    ("cat_icon_engine",   "应用管家/引擎.png"),
    ("cat_icon_game",     "应用管家/独立游戏.png"),
    ("cat_icon_tool",     "应用管家/应用.png"),
    ("cat_icon_other",    "应用管家/运维.png"),
]
